...
def welcome():
    ...
    textarea.insert(END, f'\nCustomer name:\t\t{c_name.get()}')  # Corrected get method
    textarea.insert(END, f'\nPhone Number:\t\t{c_phone.get()}')  # Corrected get method
    textarea.insert(END, f"\n===================================")
    textarea.insert(END, f'\nProduct\t\t QTY\t\tPrice')
    textarea.insert(END, f"\n===================================\n")
...
def additm():
    ...
    l.append(m)
    if item.get() == '':
        messagebox.showerror('Error', 'Please enter the items')
    else:
...
# ============TOP SECTION=============
title = Label(root, text='payment receipt', bg=bg_color, fg='white', font=('times new roman', 25, 'bold'), relief=GROOVE,
              border=12)
title.pack(fill=X)

# =================CUSTOMER DETAILS===============
F1 = LabelFrame(root, text='Customer Details', font=('times new roman', 18, 'bold'), relief=GROOVE, border=10,
                bg=bg_color, fg='gold')
...
# ===================PRODUCT DETAILS===============
F2 = LabelFrame(root, text='Product Details', font=('times new roman', 18, 'bold'), relief=GROOVE, border=10,
                bg=bg_color, fg='gold')
F2.place(x=20, y=180, width=630, height=500)

itm = Label(F2, text='Product Name', font=('times new roman', 18, 'bold'), bg=bg_color, fg='green')
...
rate = Label(F2, text='Product Rate', font=('times new roman', 18, 'bold'), bg=bg_color, fg='green')
...
quantity = Label(F2, text='Product Quantity', font=('times new roman', 18, 'bold'), bg=bg_color, fg='green')
